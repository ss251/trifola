...
<!-- Hero: demo-mode capture (generated by `--render-*`, synthetic data only) -->
<!-- ![trifola — the fleet board](docs/screenshots/hero-dark.png) -->
_A truffle pig for your agent fleet: it sniffs out the valuable — and the
wasteful — hidden in data Claude Code already writes to disk._
