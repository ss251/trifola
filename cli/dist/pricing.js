...
export function rateFromInputOutput(input, output) {
    return {
        input,
        output,
        cacheRead: input * 0.1,
 ...
 */
function rateOnDay(pricing, day) {
...
export function addUsageInPlace(a, b) {
...
export function costOfUsage(u, rate) {
 ...
 */
export function reSentContextDollarsOfUsage(u, rate) {
 ...
 */
export function firstTouchDollarsOfUsage(u, rate) {
...
export function cacheHitRateOfUsage(u) {
